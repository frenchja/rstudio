...
#ifndef DESKTOP_SYNCTEX_EVINCEWINDOW2_HPP
#define DESKTOP_SYNCTEX_EVINCEWINDOW2_HPP
...
class EvinceWindow2 : public EvinceWindow
{
    Q_OBJECT
public:
    EvinceWindow2(const QString &service, QObject *parent = 0);
    ~EvinceWindow2();
...
#endif // DESKTOP_SYNCTEX_EVINCEWINDOW2_HPP
