...
private:
                                            ...
                                            rnw_concordance::Concordances())
   {
      ...
      // run latex compile (note this is run synchronously because
      // it involves calls to multiple slave processes and the
      // async implementaiotn would threfore be a bit complicated)
